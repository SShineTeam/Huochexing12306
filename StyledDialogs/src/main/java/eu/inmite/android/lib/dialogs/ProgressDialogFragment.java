...
public class ProgressDialogFragment extends BaseDialogFragment {
	...
	protected Builder build(Builder builder) {
		...
		if (TextUtils.isEmpty(getArguments().getString(ARG_TITLE))){
			view = inflater.inflate(R.layout.dialog_part_progress_small, null, false);
		}else{
			view = inflater.inflate(R.layout.dialog_part_progress, null, false);
		}
	...
	public void setMessage(CharSequence cs1){
		tvMessage.setText(cs1);
	}
